...
-type options() :: #{use_strict := boolean(), convert_to_binary := boolean()}.

-record(node_comp, {comparator = '_' :: '_' | binary(), value = undefined :: any()}).
-record(node,
        {segment = <<>>,
         value = [] :: [#node_comp{}],
         children = [] :: [#node{}],
...
-type tree_node() :: #node{}.
-type node_comp() :: #node_comp{}.

-export_type([options/0, host_tree/0, routing_tree/0, tree_node/0, node_comp/0]).
